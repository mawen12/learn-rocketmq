...
public class RequestCode {
	...
	public static final int BROKER_CLOSE_CHANNEL_REQUEST = 1014;

	public static final int CHECK_NOT_ACTIVE_BROKER_REQUEST = 1015;

	public static final int GET_BROKER_LIVE_INFO_REQUEST = 1016;

	public static final int GET_SYNC_STATE_DATA_REQUEST = 1017;

	public static final int RAFT_BROKER_HEART_BEAT_EVENT_REQUEST = 1018;
	...
	public static final int GET_COLD_DATA_FLOW_CTR_CONFIG = 2003;
