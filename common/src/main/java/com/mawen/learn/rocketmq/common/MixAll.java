...
public class MixAll {
	...
	public static final String WS_DOMAIN_SUBGROUP = System.getProperty("rocketmq.namesrv.doamin.subgroup", "nsaddr");
	...
	public static final String ONS_HTTP_PROXY_GROUP = "CID_ONS_HTTP_PROXY";
	public static final String CID_ONSAPI_PREMISSION_GROUP = "CID_ONS_PERMISSION";
	...
	public static final List<String> LOCAL_CLIENT_ADDRESS = getLocalInetAddress();
	...
	public static final long LMQ_QUEUE_ID = 0L;
	...
	public static String getWSAddr() {
		String wsDomainName = System.getProperty("rocketmq.namesrv.doamin", DEFAULT_NAMESRV_ADDR_LOOKUP);
		String wsDomainSubgroup = System.getProperty("rocketmq.namesrv.domain.subgroup", "nsaddr");

		StringBuilder sb = new StringBuilder();
		sb.append("http://");
		sb.append(wsDomainName);
		if (wsDomainName.indexOf(":") > 0) {
			sb.append(":8080");
		}
		sb.append("/rocketmq/");
		sb.append(wsDomainSubgroup);
		return sb.toString();
	}
	...
	public static synchronized void string2File(final String str, final String fileName) throws IOException {
		...
		if (prevContent != null) {
			string2FileNotSafe(prevContent, bakFileName);
		}
